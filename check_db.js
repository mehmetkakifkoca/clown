...
function checkSizes() {
    return __awaiter(this, void 0, void 0, function () {
        var snap, _i, _a, d, data, str, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, firestore_1.getDocs)((0, firestore_1.collection)(db, "mailAccounts"))];
                case 1:
                    snap = _b.sent();
                    ...
                    for (_i = 0, _a = snap.docs; _i < _a.length; _i++) {
                        ...
                        console.log("Doc ".concat(d.id, " size: ").concat(str.length, " bytes"));
                        if (str.length > 10000) {
                ...
                case 2:
                    e_1 = _b.sent();
                    console.error("Error reading mailAccounts:", e_1);
                    return [3 /*break*/, 3];
                case 3:
                    process.exit(0);
                    return [2 /*return*/];
